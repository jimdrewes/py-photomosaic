# To reduce duplication, let's only allow images to appear if they're not within 5 tiles of one another.
...
def build_tile_map(sourceImg, library, targetDimensions):
    ...
    for x in range(targetDimensions[0]):
        for y in range(targetDimensions[1]):
            ...
            pickedImage = find_closest_library_image(library, nextcolor, tileMap, (x, y))
