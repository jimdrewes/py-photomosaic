# In this step, we're going to open the base image, determine the final image dimensions,
# and start figuring out what images we should map to the base image.
